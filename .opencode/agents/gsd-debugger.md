...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  ...
                  → checks /Users/corey/Projects/protoclaw-rust/.opencode/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/corey/Projects/protoclaw-rust/.opencode/get-shit-done
                  → writes to /Users/corey/Projects/protoclaw-rust/.opencode/get-shit-done/hooks/
...
```bash
INIT=$(node "/Users/corey/Projects/protoclaw-rust/.opencode/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/corey/Projects/protoclaw-rust/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/corey/Projects/protoclaw-rust/.opencode/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
