...
- **Global scope**: `/Users/corey/Projects/protoclaw-rust/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/corey/Projects/protoclaw-rust/.opencode/notes/`)
...
2. Glob `/Users/corey/Projects/protoclaw-rust/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (/Users/corey/Projects/protoclaw-rust/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/corey/Projects/protoclaw-rust/.opencode/notes/` — works in any directory
